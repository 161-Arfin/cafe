...
export function HeroSection() {
  return (
    <section id="top" className="relative min-h-screen overflow-hidden bg-primary">
      <Image src={siteConfig.images.hero} alt="Barista LYON’S sedang meracik kopi di meja bar" fill priority quality={100} sizes="100vw" className="hero-image object-cover object-[68%_center]" />
      ...
      <Container className="relative z-10 flex min-h-screen items-center pb-24 pt-32">
        <div className="max-w-3xl text-white">
          ...
          <div className="hero-reveal mt-10 flex flex-wrap gap-3" style={{ animationDelay: "420ms" }}><Button href="#menu" variant="gold" className="min-w-40">Lihat Menu &amp; Harga</Button><Button href={siteConfig.links.meeting} variant="outline" className="min-w-40">Booking Ruangan</Button></div>

      ...
      <Container>
        <div className="grid items-center gap-14 lg:grid-cols-[.88fr_1.12fr] lg:gap-24">
          ...
          <div className="reveal relative">
            <div className="relative aspect-[4/3] overflow-hidden rounded-card"><Image src={siteConfig.images.workspace} alt="Area coworking LYON’S dengan meja komunal dan pencahayaan alami" fill quality={100} sizes="(min-width:1024px) 55vw, 100vw" className="object-cover transition-transform duration-700 hover:scale-[1.025]" /></div>

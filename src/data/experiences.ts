...
export const experiences: ExperienceItem[] = [
  {
    ...
    imageAlt: "Area kerja LYON’S yang nyaman untuk bekerja dengan laptop",
  ...
  },
  {
    ...
    imageAlt: "Suasana pelayanan hangat di LYON’S Café",
    ctaLabel: "Cek meeting room",
    ctaHref: siteConfig.links.meeting,
  },
  {
    id: "pause",
    number: "03",
    ...
    imageAlt: "Pilihan minuman segar di meja LYON’S Café",
